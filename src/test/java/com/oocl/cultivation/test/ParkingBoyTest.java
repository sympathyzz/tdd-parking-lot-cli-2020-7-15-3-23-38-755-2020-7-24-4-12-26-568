...
public class ParkingBoyTest {
    ...
    void should_first_parkinglot_has_2_car__second_parkinglot_has_3_car_when_park_given_5_cars() {
        ...
        //then
        assertEquals(2,superSmartParkingBoy.getAllParkingLot().get(0).getParkingRooms().size());
        assertEquals(3,superSmartParkingBoy.getAllParkingLot().get(1).getParkingRooms().size());
    }
